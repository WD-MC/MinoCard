...
if(isset($_POST['valider'])){
    ...
    $departbirth = $_POST['departbirth'];
    $paysbirth = $_POST['paysbirth'];


    if($datebirth&&$lieubirth&&$departbirth&&$paysbirth){

        header("Location: residence.php");
        
        $datebirth= set($datebirth);
        $lieubirth = set($lieubirth);
        $departbirth = set($departbirth);
        $paysbirth = set($paysbirth);


        sauvegarder($datebirth);
        sauvegarder($lieubirth);
        sauvegarder($departbirth);
        sauvegarder($paysbirth);
    ...
    <!-- Footer-->
        ...
        <div class="col-6 col-md-2">
            ...
            <div class="card-img-overlay">
                ...
                <div class="text" style="font-size: 1.15rem;">
                <a class="nav-link" href="naissance.php">
        ...
        <div class="col-sm-6 col-md-8">
            ...
            <img src="images/v915-wit-002-g_2_1.jpg" class="card-img" alt="..." style="width: 74.9rem; height:43.25rem;">
                ...
                <div class="card bg-transparent border-secondary shadow-lg " style="height:2.rem; width: 50rem;">
                    ...
                    <form method="POST" action="naissance.php">
                        ...
                        <p>
                            ...
                            <input type="date" class="form-control" placeholder="jj/mm/yy" name="datebirth" id="datebirth"/>
                        </p>

                        <p>
                            <label for="lieubirth">Lieu de Naissance:</label>
                            <input type="text" class="form-control" name="lieubirth" id="lieubirth"/>
                        </p>
                        <p>
                            <label for="departbirth">Departement de naissance:</label>
                            <input type="text" class="form-control" name="departbirth" id="departbirth"/>
                        </p>

                        <p>
                            <label for="paysbirth">Pays de Naissance:</label>
                            <input type="text" class="form-control" name="paysbirth" id="paysbirth"/>
                        </p>
                        ...
                        <h8 class="text text-black text-end" >Page 3 sur 6 <h8>
