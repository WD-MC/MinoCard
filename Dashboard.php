          ...
          <div class="card-img-overlay">
            ...
            <div class="text" style="font-size: 1.15rem;">
              <a class="nav-link" href="">
                  ...
                  <h8 class="text text-primary" ><strong>Accueil</strong><h8>
              </a>
            </div>

            <div class="text" style="font-size: 1.15rem;">
              <a class="nav-link" href="infosDemande">
        ...
        <div class="card bg-light text-white">
          ...
          <div class="card-img-overlay text-center " style = "font-family:Georgia;">
            ...
            <div class="container" style="margin-left: 10rem;">
              <h1 class="card-title text-black start-50"><strong>BIENVENUE SUR MinoCard</strong></h1>
