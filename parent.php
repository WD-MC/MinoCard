...
if(isset($_POST['valider'])){
    ...
    $father= $_POST['father'];
    $fatherdate = $_POST['fatherdate'];
    $mother = $_POST['mother'];
    $motherdate = $_POST['motherdate'];
    $officier = $_POST['officier'];

    if($father&&$fatherdate&&$mother&&$motherdate&&$officier){

        header("Location: carte.php");

        $father= set($father);
        $fatherdate = set($fatherdate);
        $mother = set($mother);
        $motherdate = set($motherdate);
        $officier =set($officier);

        sauvegarder($father);
        sauvegarder($fatherdate);
        sauvegarder($mother);
        sauvegarder($motherdate);
        sauvegarder($officier);
    }else {
...
<html>
    ...
    <!-- Footer-->
        ...
        <div class="col-sm-6 col-md-8">
            ...
            <img src="images/v915-wit-002-g_2_1.jpg" class="card-img" alt="..." style="width: 83.2rem; height: 43.25rem;">
                ...
                <div class="card bg-transparent border-secondary shadow-lg " style="height:2.rem; width: 50rem;">
                    ...
                    <div class="card-body text-black text-start">
                        <form method="POST" action="parent.php">
                            ...
                            <p>
                                <label for="father">Nom du pere :</label>
                                <input type="text" class="form-control" name="father" id="father" required/>
                            </p>

                            <p>
                                <label for="fatherdate">Date de Naissance:</label>
                                <input type="date" class="form-control" placeholder="jj/mm/yy" name="fatherdate" id="fatherdate" required/>
                            </p>

                            <p>
                                <label for="mother">Nom de jeune fille de la mere  :</label>
                                <input type="text" class="form-control" name="mother" id="mother" required/>
                            </p>

                            <p>
                                <label for="motherdate">Date de naissance :</label>
                                <input type="date" class="form-control" placeholder="jj/mm/yy" name="motherdate" id="motherdate" required/>
                            </p>

                            <p>
                                <label for="officier">Nom de l'officier d'enrollement: </label>
                                <input type="text" class="form-control"  name="officier" id="officier" required/>
                            </p><br/>
                            ...
                            <h8 class="text text-black text-end" >Page 4 sur 4 <h8>
